...
/* This code belongs in ble_cus.c*/
//Check that none of the pointers passed are NULL and declare err_code and ble_uuid
uint32_t ble_cus_init(ble_cus_t * p_cus, const ble_cus_init_t * p_cus_init)
{
    ...
    // Initialize service structure, valid when in connection
...
/* This code belongs in ble_cus.c*/
//Check that no pointers provded as arguments are NULL
